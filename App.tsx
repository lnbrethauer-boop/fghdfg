...
export const App: React.FC = () => {
  ...
  const handleGenerateNewVideo = async (
    ...
    const promptToGenerate = prompt || newPrompt;
    ...
    try {
      console.log('Generating video from prompt...', promptToGenerate);
      const videoObjects = await generateVideoFromText(promptToGenerate);
      ...
      const newVideo: Video = {
        ...
        title: title || `Generated: ${promptToGenerate.substring(0, 40)}...`,
        description: promptToGenerate,
        videoUrl: src,
      };
      ...
      setGenerationError([
        ...
        'This may be due to an issue with your API key or project configuration.',
      ]);
    } finally {
      setIsSaving(false);
    }
        ...
        <div className="mx-auto max-w-[1080px]">
          <header className="p-6 md:p-8 text-center">
            ...
            <p className="text-gray-400 mt-2 text-lg">
              Select a video to generate your own variations or create from a
              new prompt
            </p>
          </header>
          <main className="px-4 md:px-8 pb-8">
            <div className="mb-8 p-6 bg-gray-800 rounded-lg shadow-2xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4 items-start">
                <textarea
                  id="prompt-input"
                  rows={4}
                  className="flex-grow w-full bg-gray-900 border border-gray-700 rounded-lg p-3 text-gray-200 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-shadow duration-200"
                ...
                <button
                  ...
                  className="w-full sm:w-auto px-6 py-2 rounded-lg bg-purple-600 hover:bg-purple-700 text-white font-semibold transition-colors disabled:bg-gray-600 disabled:cursor-not-allowed flex items-center justify-center gap-2 flex-shrink-0"
                >
